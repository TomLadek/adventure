...
const linksStore = useLinksStore(),
      ...
      { linkHref, linkText, linkTextSuggested } = storeToRefs(linksStore);

let editOrInsert;

watch(() => props.linkPopupShowing, showing => {
  if (showing)
...
<CmsPopup :popupShowing="linkPopupShowing" @keydown.prevent.escape="cancel">
  ...
  <div class="link-popup-content">
    <div class="input-container">
      ...
      <input id="link-text" type="text" name="link-text" v-model="linkText" :placeholder="linkTextSuggested" @keyup.enter="confirm">
    </div>
